                            ...
                            <div class="tab-pane" role="tabpanel">
                                ...
                                <div class="row text-center">
                                    <div class="col-md-6">
                                        <label class="form-label">Personel Seçiniz</label>
                                        <div style="text-align: center; border-style: groove;">
                                            <asp:DropDownList ID="DropDownListPersonelAdlariIade" runat="server" OnSelectedIndexChanged="DDL_PersonelAdlariIade" CssClass="btn dropdown-toggle"
                                                Style="width: 100%; border-style: groove;">
                                            </asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div style="text-align: center; border-style: groove;">
                                            <asp:DropDownList ID="DropDownListVarlikListesiIade" runat="server" OnSelectedIndexChanged="DDL_VarlikListesiIade" CssClass="btn dropdown-toggle"
                                                Style="width: 100%; border-style: groove;">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
