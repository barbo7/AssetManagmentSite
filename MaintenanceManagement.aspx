        ...
        <div class="container text-start" style="color: rgb(124,127,145); transform: skew(0deg);">
            <div>
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="SearchMaintenance" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="SearchMaintenanceButton" EventName="TextChanged" />
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-5" style="text-align: center;">
                                                        ...
                                                        <div style="text-align: center; border-style: groove;">
                                                            <asp:DropDownList ID="DropDownListProductId" runat="server" OnTextChanged="ProductId_DDL" CssClass="btn dropdown-toggle"
